<template>
  <div class="k-component-license">
    <k-box theme="notice">
      This is an unregistered version of the components plugin.
      <span v-if="doRegister" class="link" @click="$refs.regdialog.open()"
        >Register now</span
      >
    </k-box>
    <k-dialog ref="regdialog" class="k-component-license-dialog" size="medium">
      <k-grid gutter="medium">
        <k-column>
          <k-text size="large">
            Get your Component Plugin license
            <a
              href="https://license.microman.ch/?product=829857"
              target="_blank"
              >here</a
            >
          </k-text>
...
.k-component-license-dialog .loader-box {
  display: flex;
  justify-content: center;
  align-items: center;
}

.k-component-license-dialog .loader-text {
  line-height: 1.2em;
}
.k-component-license .link {
